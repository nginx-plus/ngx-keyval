...
The Nginx key/value store can be used via Curl or a simple HTTP request. Nginx allows advanced security and authentication that could enable public usage in web applications.
